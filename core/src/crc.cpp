// mef3io — CRC-32 Koopman implementation.
#include "mef3io/crc.hpp"

namespace mef3io::crc {
namespace {
// Koopman-32 reflected table (0x741B8CD7). Matches meflib CRC_KOOPMAN32_KEY.
constexpr ui4 kTable[256] = {
...
ui4 calculate(std::span<const ui1> data, ui4 initial) {
  ui4 c = initial;
  for (ui1 b : data) {
    ui4 idx = (c ^ b) & 0xFFu;
    c = (c >> 8) ^ kTable[idx];
